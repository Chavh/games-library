  ...
  methods: {
    ...
    getGames() {
      ...
      axios
        ...
        .catch((error) => {
          console.error(error);
          this.message = "Error while fetching games!";
    ...
    addGame(payload) {
      ...
      axios
        ...
        .catch((error) => {
          console.log(error);
          this.getGames();
          this.message = "Error while adding game!";
          this.showErrorMessage = true;
        });
    },
    ...
    updateGame(payload, gameID) {
      ...
      axios
        ...
        .catch((error) => {
          console.error(error);
          this.getGames();
          this.message = "Error while updating game!";
          this.showErrorMessage = true;
        });
    },
    ...
    removeGame(gameID) {
      ...
      axios
        ...
        .catch((error) => {
          ...
          console.error(error);
          this.getGames();
          this.message = "Error while removing game!";
          this.showErrorMessage = true;
        });
    },
